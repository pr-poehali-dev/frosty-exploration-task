      ...
      <div className="max-w-[1200px] mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="flex-1 max-w-lg mt-8">
            ...
            >
              Ваша защита на дороге.
            </h2>

            <div className="space-y-4 text-foreground">
              <div className="flex items-start gap-3">
                <span className="text-accent mt-1">*</span>
                <p className="text-sm">Оформлю ОСАГО или КАСКО быстро и выгодно — без очередей и лишних документов.</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-accent mt-1">*</span>
                <p className="text-sm">Сравниваю предложения ведущих страховых компаний, чтобы вы получили лучшую цену.</p>
              </div>
            </div>
          </div>
        ...
        <div id="contact" className="w-full px-6 py-16 flex flex-col md:flex-row items-center justify-center md:justify-between gap-6 md:gap-0 border-t border-border mt-16">
          ...
          <a href="https://vk.ru/enterprise_company" target="_blank" rel="noopener noreferrer">
